...
NSLog(@"width shade:  %f", widthShade);

NSLog(@"width position:  %f", self.rightOverlayView.frame.origin.x);
NSLog(@"width position thumb:  %f", self.rightThumbView.frame.origin.x);
NSLog(@"width frame:  %f", widthPosition);
